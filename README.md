...
|-------|--------|-----------|
| 🏆 [LLaTiSA: Towards Difficulty-Stratified Time Series Reasoning from Visual Perception to Semantics](https://huggingface.co/papers/2604.17295) | ⭐ 79 | AI |
| 🥈 [WorldMark: A Unified Benchmark Suite for Interactive Video World Models](https://huggingface.co/papers/2604.21686) | ⭐ 33 | AI |
| 🥉 [UniT: Toward a Unified Physical Language for Human-to-Humanoid Policy Learning and World Modeling](https://huggingface.co/papers/2604.19734) | ⭐ 26 | AI |

<sub>Last updated: 2026-04-25 13:18 UTC</sub>
